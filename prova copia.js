...
const puppeteer = require('puppeteer');
    ...
    await page.waitForSelector('.room-rates-item-price-moy');
    const currencyPrice = await page.evaluate(() => {
        let currency = document.querySelector('.room-rates-item-price-moy').innerText;
...
/* let dataBooking = fs.readFileSync('prova copy.js', 'utf-8');
